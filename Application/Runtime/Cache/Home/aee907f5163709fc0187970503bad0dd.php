...
<div class="detailBody">
    <div class="expend hidden">
        ...
        <div class="specific">
            <ul>
                <?php if(is_array($expend["flow"])): $i = 0; $__LIST__ = $expend["flow"];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li>
                        <div class="left">
                            <p class="explain"><?php echo ($vo["remarks"]); ?></p>
                            <p class="time"><?php echo (date("Y-m-d",$vo["create_time"])); ?></p>
                        </div>
                        <div class="right">
                            <p class="money"><?php echo ($vo["points"]); ?></p>
                            <img class="right" src="/public/home/images/right.png">
                        </div>
                    </li>
                    <!--<a href="<?php echo U('home/wallet/singleDetailed?type=2&flow_id='.$vo['id']);?>">-->
                        <!--<li>-->
                            <!--<div class="left">-->
                                <!--<p class="explain"><?php echo ($vo["remarks"]); ?></p>-->
                                <!--<p class="time"><?php echo (date("Y-m-d",$vo["create_time"])); ?></p>-->
    ...
    <div class="income hidden" style="display: none">
        ...
        <div class="specific">
            <ul>
                <?php if(is_array($income["flow"])): $i = 0; $__LIST__ = $income["flow"];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li>
                        <div class="left">
                            <p class="explain"><?php echo ($vo["remarks"]); ?></p>
                            <p class="time"><?php echo (date("Y-m-d",$vo["create_time"])); ?></p>
                        </div>
...
<script>
    $(".choiceTime").change(function () {
        $.ajax({
            type:"post",
            url : "<?php echo U('home/wallet/pointsDetail');?>",
            ...
            success:function (data) {
                if (data.type == "expend"){
                    ...
                    for(var i = 0;i < data.flow.flow.length;i++){
                        var url = "<?php echo U('home/wallet/singleDetailed/type/2/flow_id/" + data.flow.flow[i].id +"');?>";
